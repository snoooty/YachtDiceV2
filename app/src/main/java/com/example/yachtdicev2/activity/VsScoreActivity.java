                        ...
                        public void onClick(View v) {
                            ...
                            builder.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    intent.putExtra("player1totalScore",Integer.parseInt(P1totalScore.getText().toString()) + scoreCalc.calcAce(dice1eye,dice2eye,dice3eye,dice4eye,dice5eye));
                                    intent.putExtra("player2totalScore",Integer.parseInt(P2totalScore.getText().toString()));
                        ...
                        public void onClick(View v) {
                            ...
                            builder.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    intent.putExtra("player1totalScore",Integer.parseInt(P1totalScore.getText().toString()) + scoreCalc.calcTwo(dice1eye,dice2eye,dice3eye,dice4eye,dice5eye));
                                    intent.putExtra("player2totalScore",Integer.parseInt(P2totalScore.getText().toString()));
                                    setResult(RESULT_OK,intent);
                                    dialog.dismiss();
                                    finish();
                        ...
                        public void onClick(View v) {
                            ...
                            builder.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    intent.putExtra("player1totalScore",Integer.parseInt(P1totalScore.getText().toString()) + scoreCalc.calcThree(dice1eye,dice2eye,dice3eye,dice4eye,dice5eye));
                                    intent.putExtra("player2totalScore",Integer.parseInt(P2totalScore.getText().toString()));
                                    setResult(RESULT_OK,intent);
                                    dialog.dismiss();
                                    finish();
                        ...
                        public void onClick(View v) {
                            ...
                            builder.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    intent.putExtra("player1totalScore",Integer.parseInt(P1totalScore.getText().toString()) + scoreCalc.calcFour(dice1eye,dice2eye,dice3eye,dice4eye,dice5eye));
                                    intent.putExtra("player2totalScore",Integer.parseInt(P2totalScore.getText().toString()));
                                    setResult(RESULT_OK,intent);
                                    dialog.dismiss();
                                    finish();
                        ...
                        public void onClick(View v) {
                            ...
                            builder.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    intent.putExtra("player1totalScore",Integer.parseInt(P1totalScore.getText().toString()) + scoreCalc.calcFive(dice1eye,dice2eye,dice3eye,dice4eye,dice5eye));
                                    intent.putExtra("player2totalScore",Integer.parseInt(P2totalScore.getText().toString()));
                                    setResult(RESULT_OK,intent);
                                    dialog.dismiss();
                                    finish();
                        ...
                        public void onClick(View v) {
                            ...
                            builder.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    intent.putExtra("player1totalScore",Integer.parseInt(P1totalScore.getText().toString()) + scoreCalc.calcSix(dice1eye,dice2eye,dice3eye,dice4eye,dice5eye));
                                    intent.putExtra("player2totalScore",Integer.parseInt(P2totalScore.getText().toString()));
                                    setResult(RESULT_OK,intent);
                                    dialog.dismiss();
                                    finish();
                        ...
                        public void onClick(View v) {
                            ...
                            builder.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    intent.putExtra("player1totalScore",Integer.parseInt(P1totalScore.getText().toString()) + scoreCalc.calcThreeOfAKind(dice1eye,dice2eye,dice3eye,dice4eye,dice5eye));
                                    intent.putExtra("player2totalScore",Integer.parseInt(P2totalScore.getText().toString()));
                                    setResult(RESULT_OK,intent);
                                    dialog.dismiss();
                                    finish();
                        ...
                        public void onClick(View v) {
                            ...
                            builder.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    intent.putExtra("player1totalScore",Integer.parseInt(P1totalScore.getText().toString()) + scoreCalc.calcFourOfAKind(dice1eye,dice2eye,dice3eye,dice4eye,dice5eye));
                                    intent.putExtra("player2totalScore",Integer.parseInt(P2totalScore.getText().toString()));
                                    setResult(RESULT_OK,intent);
                                    dialog.dismiss();
                                    finish();
                        ...
                        public void onClick(View v) {
                            ...
                            builder.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    intent.putExtra("player1totalScore",Integer.parseInt(P1totalScore.getText().toString()) + scoreCalc.calcFullHouse(dice1eye,dice2eye,dice3eye,dice4eye,dice5eye));
                                    intent.putExtra("player2totalScore",Integer.parseInt(P2totalScore.getText().toString()));
                                    setResult(RESULT_OK,intent);
                                    dialog.dismiss();
                                    finish();
                        ...
                        public void onClick(View v) {
                            ...
                            builder.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    intent.putExtra("player1totalScore",Integer.parseInt(P1totalScore.getText().toString()) + scoreCalc.calcSmallStraight(dice1eye,dice2eye,dice3eye,dice4eye,dice5eye));
                                    intent.putExtra("player2totalScore",Integer.parseInt(P2totalScore.getText().toString()));
                                    setResult(RESULT_OK,intent);
                                    dialog.dismiss();
                                    finish();
                        ...
                        public void onClick(View v) {
                            ...
                            builder.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    intent.putExtra("player1totalScore",Integer.parseInt(P1totalScore.getText().toString()) + scoreCalc.calcLargeStraight(dice1eye,dice2eye,dice3eye,dice4eye,dice5eye));
                                    intent.putExtra("player2totalScore",Integer.parseInt(P2totalScore.getText().toString()));
                                    setResult(RESULT_OK,intent);
                                    dialog.dismiss();
                                    finish();
                        ...
                        public void onClick(View v) {
                            ...
                            builder.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    intent.putExtra("player1totalScore",Integer.parseInt(P1totalScore.getText().toString()) + scoreCalc.calcChance(dice1eye,dice2eye,dice3eye,dice4eye,dice5eye));
                                    intent.putExtra("player2totalScore",Integer.parseInt(P2totalScore.getText().toString()));
                                    setResult(RESULT_OK,intent);
                                    dialog.dismiss();
                                    finish();
                        ...
                        public void onClick(View v) {
                            ...
                            builder.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    intent.putExtra("player1totalScore",Integer.parseInt(P1totalScore.getText().toString()) + scoreCalc.calcYACHT(dice1eye,dice2eye,dice3eye,dice4eye,dice5eye));
                                    intent.putExtra("player2totalScore",Integer.parseInt(P2totalScore.getText().toString()));
                                    setResult(RESULT_OK,intent);
                                    dialog.dismiss();
                                    finish();
                        ...
                        public void onClick(View v) {
                            ...
                            builder.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    intent.putExtra("score",scoreCalc.calcAce(dice1eye,dice2eye,dice3eye,dice4eye,dice5eye));
                                    intent.putExtra("player1totalScore",Integer.parseInt(P1totalScore.getText().toString()));
                                    intent.putExtra("player2totalScore",Integer.parseInt(P2totalScore.getText().toString()) + scoreCalc.calcAce(dice1eye,dice2eye,dice3eye,dice4eye,dice5eye));
                                    setResult(RESULT_OK,intent);
                                    dialog.dismiss();
                                    finish();
                        ...
                        public void onClick(View v) {
                            ...
                            builder.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    intent.putExtra("score",scoreCalc.calcTwo(dice1eye,dice2eye,dice3eye,dice4eye,dice5eye));
                                    intent.putExtra("player1totalScore",Integer.parseInt(P1totalScore.getText().toString()));
                                    intent.putExtra("player2totalScore",Integer.parseInt(P2totalScore.getText().toString()) + scoreCalc.calcTwo(dice1eye,dice2eye,dice3eye,dice4eye,dice5eye));
                                    setResult(RESULT_OK,intent);
                                    dialog.dismiss();
                                    finish();
                        ...
                        public void onClick(View v) {
                            ...
                            builder.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    intent.putExtra("score",scoreCalc.calcThree(dice1eye,dice2eye,dice3eye,dice4eye,dice5eye));
                                    intent.putExtra("player1totalScore",Integer.parseInt(P1totalScore.getText().toString()));
                                    intent.putExtra("player2totalScore",Integer.parseInt(P2totalScore.getText().toString()) + scoreCalc.calcThree(dice1eye,dice2eye,dice3eye,dice4eye,dice5eye));
                                    setResult(RESULT_OK,intent);
                                    dialog.dismiss();
                                    finish();
                        ...
                        public void onClick(View v) {
                            ...
                            builder.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    intent.putExtra("score",scoreCalc.calcFour(dice1eye,dice2eye,dice3eye,dice4eye,dice5eye));
                                    intent.putExtra("player1totalScore",Integer.parseInt(P1totalScore.getText().toString()));
                                    intent.putExtra("player2totalScore",Integer.parseInt(P2totalScore.getText().toString()) + scoreCalc.calcFour(dice1eye,dice2eye,dice3eye,dice4eye,dice5eye));
                                    setResult(RESULT_OK,intent);
                                    dialog.dismiss();
                                    finish();
                        ...
                        public void onClick(View v) {
                            ...
                            builder.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    intent.putExtra("score",scoreCalc.calcFive(dice1eye,dice2eye,dice3eye,dice4eye,dice5eye));
                                    intent.putExtra("player1totalScore",Integer.parseInt(P1totalScore.getText().toString()));
                                    intent.putExtra("player2totalScore",Integer.parseInt(P2totalScore.getText().toString()) + scoreCalc.calcFive(dice1eye,dice2eye,dice3eye,dice4eye,dice5eye));
                                    setResult(RESULT_OK,intent);
                                    dialog.dismiss();
                                    finish();
                        ...
                        public void onClick(View v) {
                            ...
                            builder.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    intent.putExtra("score",scoreCalc.calcSix(dice1eye,dice2eye,dice3eye,dice4eye,dice5eye));
                                    intent.putExtra("player1totalScore",Integer.parseInt(P1totalScore.getText().toString()));
                                    intent.putExtra("player2totalScore",Integer.parseInt(P2totalScore.getText().toString()) + scoreCalc.calcSix(dice1eye,dice2eye,dice3eye,dice4eye,dice5eye));
                                    setResult(RESULT_OK,intent);
                                    dialog.dismiss();
                                    finish();
                        ...
                        public void onClick(View v) {
                            ...
                            builder.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    intent.putExtra("score",scoreCalc.calcThreeOfAKind(dice1eye,dice2eye,dice3eye,dice4eye,dice5eye));
                                    intent.putExtra("player1totalScore",Integer.parseInt(P1totalScore.getText().toString()));
                                    intent.putExtra("player2totalScore",Integer.parseInt(P2totalScore.getText().toString()) + scoreCalc.calcThreeOfAKind(dice1eye,dice2eye,dice3eye,dice4eye,dice5eye));
                                    setResult(RESULT_OK,intent);
                                    dialog.dismiss();
                                    finish();
                        ...
                        public void onClick(View v) {
                            ...
                            builder.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    intent.putExtra("score",scoreCalc.calcFourOfAKind(dice1eye,dice2eye,dice3eye,dice4eye,dice5eye));
                                    intent.putExtra("player1totalScore",Integer.parseInt(P1totalScore.getText().toString()));
                                    intent.putExtra("player2totalScore",Integer.parseInt(P2totalScore.getText().toString()) + scoreCalc.calcFourOfAKind(dice1eye,dice2eye,dice3eye,dice4eye,dice5eye));
                                    setResult(RESULT_OK,intent);
                                    dialog.dismiss();
                                    finish();
                        ...
                        public void onClick(View v) {
                            ...
                            builder.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    intent.putExtra("score",scoreCalc.calcFullHouse(dice1eye,dice2eye,dice3eye,dice4eye,dice5eye));
                                    intent.putExtra("player1totalScore",Integer.parseInt(P1totalScore.getText().toString()));
                                    intent.putExtra("player2totalScore",Integer.parseInt(P2totalScore.getText().toString()) + scoreCalc.calcFullHouse(dice1eye,dice2eye,dice3eye,dice4eye,dice5eye));
                                    setResult(RESULT_OK,intent);
                                    dialog.dismiss();
                                    finish();
                        ...
                        public void onClick(View v) {
                            ...
                            builder.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    intent.putExtra("score",scoreCalc.calcSmallStraight(dice1eye,dice2eye,dice3eye,dice4eye,dice5eye));
                                    intent.putExtra("player1totalScore",Integer.parseInt(P1totalScore.getText().toString()));
                                    intent.putExtra("player2totalScore",Integer.parseInt(P2totalScore.getText().toString()) + scoreCalc.calcSmallStraight(dice1eye,dice2eye,dice3eye,dice4eye,dice5eye));
                                    setResult(RESULT_OK,intent);
                                    dialog.dismiss();
                                    finish();
                        ...
                        public void onClick(View v) {
                            ...
                            builder.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    intent.putExtra("score",scoreCalc.calcLargeStraight(dice1eye,dice2eye,dice3eye,dice4eye,dice5eye));
                                    intent.putExtra("player1totalScore",Integer.parseInt(P1totalScore.getText().toString()));
                                    intent.putExtra("player2totalScore",Integer.parseInt(P2totalScore.getText().toString()) + scoreCalc.calcLargeStraight(dice1eye,dice2eye,dice3eye,dice4eye,dice5eye));
                                    setResult(RESULT_OK,intent);
                                    dialog.dismiss();
                                    finish();
                        ...
                        public void onClick(View v) {
                            ...
                            builder.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    intent.putExtra("score",scoreCalc.calcChance(dice1eye,dice2eye,dice3eye,dice4eye,dice5eye));
                                    intent.putExtra("player1totalScore",Integer.parseInt(P1totalScore.getText().toString()));
                                    intent.putExtra("player2totalScore",Integer.parseInt(P2totalScore.getText().toString()) + scoreCalc.calcChance(dice1eye,dice2eye,dice3eye,dice4eye,dice5eye));
                                    setResult(RESULT_OK,intent);
                                    dialog.dismiss();
                                    finish();
                        ...
                        public void onClick(View v) {
                            ...
                            builder.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    intent.putExtra("score",scoreCalc.calcYACHT(dice1eye,dice2eye,dice3eye,dice4eye,dice5eye));
                                    intent.putExtra("player1totalScore",Integer.parseInt(P1totalScore.getText().toString()));
                                    intent.putExtra("player2totalScore",Integer.parseInt(P2totalScore.getText().toString()) + scoreCalc.calcYACHT(dice1eye,dice2eye,dice3eye,dice4eye,dice5eye));
                                    setResult(RESULT_OK,intent);
                                    dialog.dismiss();
                                    finish();
