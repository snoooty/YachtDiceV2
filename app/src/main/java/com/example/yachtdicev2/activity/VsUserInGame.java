                ...
                new ActivityResultCallback<ActivityResult>() {
                    ...
                    public void onActivityResult(ActivityResult result) {
                            if (result.getResultCode() == Activity.RESULT_OK){
                                ...
                                receiveMessage.player1totalScore = Integer.parseInt(result.getData().getStringExtra("player1totalScore"));
                                receiveMessage.player2totalScore = Integer.parseInt(result.getData().getStringExtra("player2totalScore"));
